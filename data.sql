...
CREATE TABLE reservations (
    ...
    time_at time without time zone NOT NULL,
...
COPY public.reservations (id, customer_id, date_at, time_at, num_guests, notes) FROM stdin;
...
CREATE INDEX reservations_date_at_idx ON public.reservations USING btree (date_at);
